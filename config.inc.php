...
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商
	...
	$dbhost = 'localhost:/tmp/MySQL.sock';			// 数据库服务器
	$dbuser = 'root';			// 数据库用户名
	$dbpw = '';				// 数据库密码
	$dbname = 'discuz2';			// 数据库名
...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'alex.chien@koocaa.com';		// 系统管理员 Email
...
define('UC_DBHOST', 'localhost:/tmp/MySQL.sock');
define('UC_DBUSER', 'root');
define('UC_DBPW', '');
define('UC_DBNAME', 'discuz2');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`discuz2`.cdb_uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '3cIbf1Mao6I3S6gfWb44Tetd2bI7GdVde6444eh43fe94fH1G35bk9PdcfF331Q6');
define('UC_API', 'http://discuz2.local/uc_server');

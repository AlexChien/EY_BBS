...
(
	...
	'attachment_expired' => '对不起，原附件链接已失效。<br /><a href=\"attachment.php?aid=$aid&k=$key&t=$timestamp&sid=$sidauth\">[ 重新下载请点击这里 ]</a><br /><a href=\"redirect.php?goto=findpost&pid=$attach[pid]&ptid=$attach[tid]\">[ 查看原帖请点击这里 ]</a>',
	...
	'credits_policy_num_lowerlimit' => '对不起，您的{$extcredits[$id][title]}不足，无法进行本操作(小于 {$extcredits[$id][lowerlimit]} {$extcredits[$id][unit]})。',
	...
	'credits_addfunds_succeed' => '订单提交成功，请<a href=\"{$requesturl}\" target=\"_blank\"><b>点击此处</b></a>支付',
